/*!
 * JavaScript code for dropdown menu (created: November 24, 2020 05:15:26, Hash: 2450)
 * Copyright (c) 2003-2020 Dropdown Menu Generator. All rights reserved.
...
function cmnc() {
  ...
  this.oVs = function(w) {
    var rs = false;
    if (!w) return rs;
    if (w.style.visibility == 'visible') rs = true;
    return rs;
  };
  ...
  this.WinScrV = function() {
    ...
    var of = null;
    if (typeof rt.currentStyle !== 'undefined') of = rt.currentStyle.overflow; of = of || window.getComputedStyle(rt, '').overflow;
    var ofY = null;
    if (typeof rt.currentStyle !== 'undefined') ofY = rt.currentStyle.overflowY;
  ...
  this.SetAttr2 = function(obj, name, val) {
    try {
      ...
      attr.value = val;
      if (val == '') obj.removeAttribute(name);
    } catch (e) {
      alert(e);
    }
  };
...
function dmc() {
  ...
  this.HighlightItem = function(mid, iid, t) {
    ...
    if (mlt) {
      ...
      for (i = 0; i < iid.length; ++i) {
        ...
        _lvl = -1;
        if (_ob.className.indexOf('SubMenuItem') > 0) _lvl = 2;
        _ob.lvl = _lvl;
        res[i] = _ob;
      }
  ...
  this.SelUnselMlt = function(uid, Elms, op) {
    ...
    for (i = 0; i < Elms.length; ++i) {
      ...
      if (Elm) {
        _lvl = -1;
        if (Elm.className.indexOf('SubMenuItem') > 0) _lvl = 2;
  ...
  this.ShHdItm = function(mid, iid, ShHd, t) {
    ...
    var attr = '';
    if (ShHd == '0') attr = 'display:none !important';
...
function AddGlyphs(Path) {
  cmn.RegWbFnt('MG_Icons24', 'MG_Icons24', Path + 'MG_Icons', 'r292209255', true);
};

function AddCss_AmbassMenu(Path, HostURL) {
  var Css = '.A1402MainMenuDIV *, .A1402SubMenuDIV * {-webkit-box-sizing: content-box !important;-moz-box-sizing: content-box !important;box-sizing: content-box !important;}.A1402MainMenuDIV TD, .A1402SubMenuDIV TD {vertical-align: middle;border: none;padding: 0px;}.A1402Defaults {color: #3F4A9D;OverlapVertical: -5px;OverlapHorizontal: 6px;}.A1402IconTD, .A1402TitleTD, .A1402ArrowTD, .A1402HeaderTD, .A1402TitleTD * {text-shadow: none;font-size: 23px;font-family: Verdana;white-space: nowrap;padding: 0px;line-height: normal;vertical-align: middle;}.A1402TitleTD {text-align: center;}.A1402IconTD font, .A1402ArrowTD font {margin: 0 !important;display: block !important;padding: 0px;line-height: 23px;}.A1402MainMenuDIV {border: solid 1px !important;border-color: #333C7D !important;padding: 4px;padding-left: 12px;padding-right: 12px;background-color: #414C9F;background: -moz-linear-gradient(top, #6872C1 0%, #414CA0 100%); background: -webkit-linear-gradient(top, #6872C1 0%, #414CA0 100%); background: linear-gradient(to bottom, #6872C1 0%, #414CA0 100%); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=\'#6872C1\', endColorstr=\'#414CA0\', GradientType=0);;cursor: default;}.A1402MainMenuDIV .A1402HeaderTD {text-align: center;padding-left: 21px !important;padding-right: 21px !important;color: #BBC0E3;}.A1402MainMenuDIV TABLE {width: auto;border: none;border-collapse: separate;margin: 0px;padding: 0px;}.A1402MainMenuDIV{width:100%;overflow:hidden;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;}.A1402MainMenuItemTD {padding: 21px !important;padding-left: 21px !important;padding-right: 21px !important;}.A1402MainMenuItemTD .A1402TitleTD, .A1402MainMenuItemTD .A1402IconTD, .A1402MainMenuItemTD .A1402ArrowTD {color: #FFFFFF;text-shadow: 1px 1px 1px #333C7D;}.A1402MainMenuItemHoveredTD {padding: 21px !important;padding-left: 21px !important;padding-right: 21px !important;background-color: #3F4A9D;cursor: default;cursor: hand;cursor: pointer;}.A1402MainMenuItemHoveredTD .A1402TitleTD, .A1402MainMenuItemHoveredTD .A1402IconTD, .A1402MainMenuItemHoveredTD .A1402ArrowTD {color: #FFFFFF;text-shadow: 1px 1px 1px #1B2043;}.A1402MainMenuItemSelectedTD {padding: 21px !important;padding-left: 21px !important;padding-right: 21px !important;background-color: #707AC4;}.A1402MainMenuItemSelectedTD .A1402TitleTD, .A1402MainMenuItemSelectedTD .A1402IconTD, .A1402MainMenuItemSelectedTD .A1402ArrowTD {color: #FFFFFF;}.A1402SubMenuDIV {border: solid 1px !important;border-color: #212651 !important;-moz-box-sizing: content-box;-webkit-box-sizing: content-box;box-sizing: content-box;padding: 6px;background-color: #3F4A9D;cursor: default;}.A1402SubMenuDIV .A1402HeaderTD {text-align: center;padding: 32px !important;padding-left: 32px !important;padding-right: 32px !important;color: #070913;text-shadow: 1px 1px 1px #505CB8;}.A1402SubMenuDIV TABLE {border: none;border-collapse: separate;width: auto !important;margin: 0px;padding: 0px;}.A1402SubMenuItemTD, .A1402SubResDIV {padding: 33px !important;padding-left: 33px !important;padding-right: 33px !important;}.A1402SubMenuItemTD .A1402TitleTD, .A1402SubMenuItemTD .A1402IconTD, .A1402SubMenuItemTD .A1402ArrowTD, .A1402SubResDIV {color: #FFFFFF;text-shadow: 1px 1px 1px #1B2043;}.A1402SubMenuItemHoveredTD, .A1402SubResDIV:hover {padding: 33px !important;padding-left: 33px !important;padding-right: 33px !important;background-color: #414CA0;cursor: default;cursor: hand;cursor: pointer;}.A1402SubMenuItemHoveredTD .A1402TitleTD, .A1402SubMenuItemHoveredTD .A1402IconTD, .A1402SubMenuItemHoveredTD .A1402ArrowTD, .A1402SubResDIV:hover {color: #FFFFFF;text-shadow: 1px 1px 1px #333C7D;}.A1402SubMenuItemSelectedTD {padding: 33px !important;padding-left: 33px !important;padding-right: 33px !important;background-color: #2E3774;}.A1402SubMenuItemSelectedTD .A1402TitleTD, .A1402SubMenuItemSelectedTD .A1402IconTD, .A1402SubMenuItemSelectedTD .A1402ArrowTD {color: #FFFFFF;text-shadow: 1px 1px 1px #1B2043;}.A1402SeparatorVerticalTD {padding: 0px !important;background-color: #6973C1 !important;border-left-style: solid !important;border-left-width: 1px !important;border-left-color: #414CA0 !important;}.A1402SeparatorVerticalTD TABLE {width: 1px !important;}.A1402SeparatorHorizontalTD {padding: 0px !important;background-color: #505CB8 !important;border-top-style: solid !important;border-top-width: 1px !important;border-top-color: #2E3774 !important;}.A1402MltClmnSepar1TD {padding-left: 4px !important;}.A1402MltClmnSepar1AddTD {border-left-style: solid !important;border-left-width: 1px !important;border-left-color: #505CB8 !important;}.A1402MltClmnSepar2TD {padding-right: 4px !important;border-right-style: solid !important;border-right-width: 1px !important;border-right-color: #2E3774 !important;}.A1402SepVertHorSubmTD {border-left-color: #2E3774 !important;background-color: #505CB8 !important;}.A1402TooltipDIV {font-family: Verdana;font-size: 12px;color: #555555;padding: 3px;padding-left: 5px;padding-right: 5px;background-color: #F8F8F8;border: solid 1px #888888;}.A1402SubMenuDIV, .A1402TooltipDIV {-webkit-box-shadow: 3px 3px 7px 0px rgba(50, 50, 50, 0.20); -moz-box-shadow: 3px 3px 7px 0px rgba(50, 50, 50, 0.20); box-shadow: 3px 3px 7px 0px rgba(50, 50, 50, 0.20);}.A1402MainMenuDIV, .A1402SubMenuDIV {border-radius: 4px; -webkit-border-radius:4px; -khtml-border-radius:4px; -moz-border-radius:4px;}.A1402MainMenuItemHoveredTD, .A1402MainMenuItemSelectedTD, .A1402SubMenuItemHoveredTD, .A1402SubResDIV:hover, .A1402SubMenuItemSelectedTD, .A1402TooltipDIV {border-radius: 3px; -webkit-border-radius:3px; -khtml-border-radius:3px; -moz-border-radius:3px;}.A1402IconTD {color: #1B2044;vertical-align: middle;text-align: center;}.A1402IconTD font {font-size: 24px;padding-left: 4px;padding-right: 10px;width: 24px;}.A1402ArrowNotitleTD font {padding-left: 0px !important;}.A1402SubResDIV {font-family: Verdana;font-size: 23px;color: #FFFFFF;padding: 4px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;vertical-align: middle;line-height: 24px;}.A1402SubResDIV font {margin-top: 0px;margin-right: 10px;font-size: 24px;float: left;}.A1402SubResDIV:hover {color: #FFFFFF;}';


  cmn.RegPageCss('Style_Menu_A1402', Css, true);
};
var gbd4Hirq0nTydAmbassMenu = 'mn1C647DDD';
var mn1C647DDDi = function() {
  dm.i('mn1C647DDD', 0);
};
var mn1C647DDDL = null;

function mn1C647DDDLCn(Path) {
  this.id = 'AmbassMenu';
  this.uid = 'AmbassMenu';
  this.sfu = Path;
  this.ccp = 'A1402';
  ...
  this.SelIts = null;
  this.SMH = '200';
  this.nids = '<ii1/><ii2/><ii3/><ii4/><ii5/><ii6/><ii7/><ii8/>';
  this.SbmAtHd = true;
  this.PosVertTyp = '1';
};
...
var AmbassMenu = {
  ...
  CCP: 'A1402',
  Prepare: function() {
    var Ident = 'AmbassMenu';
    var Path = AmbassMenu._path;
    var HostURL = '';
    ...
    AddCss_AmbassMenu(Path, HostURL);
    mn1C647DDDL = new mn1C647DDDLCn(Path);
    AmbassMenu.Mnu = '<div><input id="sit_mn1C647DDD_vs" name="sit_mn1C647DDD_vs" type="hidden" value="" /></div><div class="A1402MainMenuDIV A1402RespMainMenuDIV" style="display:none;text-align:right;" id="mn1C647DDD_Mob" onclick="dm.RspSubShHd(\'mn1C647DDD\');"><table border="0" cellpadding="0" cellspacing="0" style="margin-left:auto;margin-right:0px;width:100%;"><tr><td onmouseover="dm.MrkItm(this,\'h\',1,\'mn1C647DDD\');" onmouseout="dm.MrkItm(this,\'n\',1,\'mn1C647DDD\');" class="A1402MainMenuItemTD"><table border="0" cellpadding="0" cellspacing="0" style="width:100%;"><tr><td style="text-align:center !important;" class="A1402TitleTD">&nbsp;&nbsp;Ambassadors Of Comedy</td><td class="A1402IconTD"><font class="MG_Icons24" style="position: absolute; left: 20px; top: 25px";" id="mn1C647DDD_MobIcn">&#xe777;</font></td></tr></table></td></tr></table></div><div id="mn1C647DDD_-0p" class="A1402MainMenuDIV" onmouseover="dm.vD();" onmouseout="dm.uD();" style="z-index:999999;position:static;vertical-align:top;text-align:center;"><table border="0" cellspacing="0" cellpadding="0" style="display:inline-block;vertical-align:top;" onclick="dm.mc();"><tr><td onmouseout="dm.u(this);" id="mn1C647DDD_i1" onclick="dm.ItClk(this,\'\',\'1\');cmn.href(\'index.html\',\'\');" class="A1402MainMenuItemTD" onmouseover="dm.v(this, 1);"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="A1402IconTD">&nbsp;</td><td class="A1402TitleTD" id="mn1C647DDD_i1-tl">Home</td><td class="A1402ArrowTD">&nbsp;</td></tr></table></td><td class="A1402SeparatorVerticalTD"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="width:1px;height:1px;" /></tr></table></td><td onmouseout="dm.u(this);" id="mn1C647DDD_i2" onclick="dm.ItClk(this,\'\',\'1\');cmn.href(\'about.html\',\'\');" class="A1402MainMenuItemTD" onmouseover="dm.v(this, 1);"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="A1402IconTD">&nbsp;</td><td class="A1402TitleTD" id="mn1C647DDD_i2-tl">About</td><td class="A1402ArrowTD">&nbsp;</td></tr></table></td><td class="A1402SeparatorVerticalTD"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="width:1px;height:1px;" /></tr></table></td><td onmouseout="dm.u(this);" id="mn1C647DDD_i3" onclick="dm.ItClk(this,\'\',\'1\');cmn.href(\'press.html\',\'\');" class="A1402MainMenuItemTD" onmouseover="dm.v(this, 1);"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="A1402IconTD">&nbsp;</td><td class="A1402TitleTD" id="mn1C647DDD_i3-tl">Press</td><td class="A1402ArrowTD">&nbsp;</td></tr></table></td><td class="A1402SeparatorVerticalTD"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="width:1px;height:1px;" /></tr></table></td><td onmouseout="dm.u(this);" id="mn1C647DDD_i4" onclick="dm.ItClk(this,\'\',\'1\');cmn.href(\'tour.html\',\'\');" class="A1402MainMenuItemTD" onmouseover="dm.v(this, 1);"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="A1402IconTD">&nbsp;</td><td class="A1402TitleTD" id="mn1C647DDD_i4-tl">Calendar</td><td class="A1402ArrowTD">&nbsp;</td></tr></table></td><td class="A1402SeparatorVerticalTD"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="width:1px;height:1px;" /></tr></table></td><td onmouseout="dm.u(this);" id="mn1C647DDD_i5" onclick="dm.ItClk(this,\'\',\'1\');cmn.href(\'contact.html\',\'\');" class="A1402MainMenuItemTD" onmouseover="dm.v(this, 1);"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="A1402IconTD">&nbsp;</td><td class="A1402TitleTD" id="mn1C647DDD_i5-tl">Contact</td><td class="A1402ArrowTD">&nbsp;</td></tr></table></td><td class="A1402SeparatorVerticalTD"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="width:1px;height:1px;" /></tr></table></td><td onmouseout="dm.u(this);" id="mn1C647DDD_i6" onclick="dm.ItClk(this,\'\',\'1\');cmn.href(\'photos.html\',\'\');" class="A1402MainMenuItemTD" onmouseover="dm.v(this, 1);"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="A1402IconTD">&nbsp;</td><td class="A1402TitleTD" id="mn1C647DDD_i6-tl">Gallery</td><td class="A1402ArrowTD">&nbsp;</td></tr></table></td><td class="A1402SeparatorVerticalTD"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="width:1px;height:1px;" /></tr></table></td><td onmouseout="dm.u(this);" id="mn1C647DDD_i7" onclick="dm.ItClk(this,\'\',\'1\');cmn.href(\'merchandise.html\',\'\');" class="A1402MainMenuItemTD" onmouseover="dm.v(this, 1);"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="A1402IconTD">&nbsp;</td><td class="A1402TitleTD" id="mn1C647DDD_i7-tl">Shop</td><td class="A1402ArrowTD">&nbsp;</td></tr></table></td><td class="A1402SeparatorVerticalTD"><table border="0" cellpadding="0" cellspacing="0"><tr><td style="width:1px;height:1px;" /></tr></table></td><td onmouseout="dm.u(this);" id="mn1C647DDD_i8" onclick="dm.ItClk(this,\'\',\'1\');cmn.href(\'testimonials.html\',\'\');" class="A1402MainMenuItemTD" onmouseover="dm.v(this, 1);"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="A1402IconTD">&nbsp;</td><td class="A1402TitleTD" id="mn1C647DDD_i8-tl">Testimonials</td><td class="A1402ArrowTD">&nbsp;</td></tr></table></td></tr></table></div>';
    AmbassMenu.SubMnu = '<div id="<r>ifc"></div><div id="<r>_Mob-p"<t>RespSubMenuDIV" style="visibility:hidden;overflow:hidden;padding:0px;left:1px;top:1px;width:1px;height:1px;position:absolute;z-index:1000000;"><div<t>SubMenuDIV"><div<t>SubResDIV" style="padding-left:8px !important;       " onclick="cmn.href(&#39;index.html&#39;,&#39;&#39;);dm.RspSubHd(&#39;<r>&#39;);">Home<0>8px !important;       " onclick="cmn.href(&#39;about.html&#39;,&#39;&#39;);dm.RspSubHd(&#39;<r>&#39;);">About<0>8px !important;       " onclick="cmn.href(&#39;press.html&#39;,&#39;&#39;);dm.RspSubHd(&#39;<r>&#39;);">Press<0>8px !important;       " onclick="cmn.href(&#39;tour.html&#39;,&#39;&#39;);dm.RspSubHd(&#39;<r>&#39;);">Calendar<0>8px !important;       " onclick="cmn.href(&#39;contact.html&#39;,&#39;&#39;);dm.RspSubHd(&#39;<r>&#39;);">Contact<0>8px !important;       " onclick="cmn.href(&#39;photos.html&#39;,&#39;&#39;);dm.RspSubHd(&#39;<r>&#39;);">Gallery<0>8px !important;       " onclick="cmn.href(&#39;merchandise.html&#39;,&#39;&#39;);dm.RspSubHd(&#39;<r>&#39;);">Shop<0>8px !important;       " onclick="cmn.href(&#39;testimonials.html&#39;,&#39;&#39;);dm.RspSubHd(&#39;<r>&#39;);">Testimonials</div></div></div>';
    AmbassMenu.SubMnu = cmn.DeCompact(AmbassMenu.SubMnu, 'A1402', 'mn1C647DDD', 'MG_Icons24', '1');
  },
  ...
  GetDst: function() {
    var DstID = AmbassMenu._div;
    if (DstID == '') DstID = 'AmbassMenu';
    var Dst = cmn.Mko(DstID);
    return Dst;
  },

  PlaceAuto: function(p, d, sb) {
    AmbassMenu.Plcd = false;
    AmbassMenu._path = '';
    AmbassMenu._div = '';
    AmbassMenu._SbMnu = false;
    ...
    if (sb == true) {
      AmbassMenu._SbMnu = true;
    }
    AmbassMenu.Prepare();
    AmbassMenu.addEvent(window, 'load', AmbassMenu.PutInDIV);
    AmbassMenu.PutInDIV_TO(0);
  },

  PutInDIV_TO: function(t) {
    var Dst = AmbassMenu.GetDst();
    if (Dst == null || Dst == undefined) {
      if (t < 50) {
        t++;
        setTimeout('AmbassMenu.PutInDIV_TO(' + t + ');', 50);
        return;
      }
    } else {
      AmbassMenu.PutInDIV();
  ...
  PutInDIV: function() {
    if (AmbassMenu.Plcd == true) return;
    var Dst = AmbassMenu.GetDst();
    if (Dst == null || Dst == undefined) {
      return;
    }
    ...
    if (AmbassMenu._SbMnu == true) {
      Dst.innerHTML = AmbassMenu.Mnu + AmbassMenu.SubMnu;
    } else {
      Dst.innerHTML = AmbassMenu.Mnu;
      var Dv = document.createElement('DIV');
      Dv.innerHTML = AmbassMenu.SubMnu;
      document.body.appendChild(Dv);
    }

    setTimeout('mn1C647DDDi()', 10);
    AmbassMenu.Plcd = true;
    var Mnu = cmn.Mko('mn1C647DDD_-0p');
    if (Mnu != null) {
      var ShMn = function() {
  ...
  Show: function() {
    AmbassMenu.Plcd = false;
    AmbassMenu.Prepare();
    document.write(AmbassMenu.Mnu + AmbassMenu.SubMnu);
    setTimeout('mn1C647DDDi()', 10);
    AmbassMenu.Plcd = true;
  }

};
AmbassMenu.PlaceAuto();
